 ...
 */
public class WindowFactoryChunkParallelDataSetWindow
    ...
    public static WindowList constructWindows(
        ...
        log.info("Constructing windows and state D");
        ...
        // create window list
        final WindowListChunkParallelDatasetWindow list = new WindowListChunkParallelDatasetWindow(mapper);

        // init chromosome list
        list.initChromosome(genome);
        ...
        new ParallelForInt2(p2, 0, chunks).loop(new IterationInt() {
            ...
            public void iteration(int index) {
                ...
                //number of data sets
                int numberOfDataSets = mapper.getNumberOfDataSets();
                for (int currentDataSet = 0; currentDataSet < numberOfDataSets; currentDataSet++) {
