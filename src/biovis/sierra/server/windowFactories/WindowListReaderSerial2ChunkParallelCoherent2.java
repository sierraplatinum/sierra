 ...
 */
public class WindowListReaderSerial2ChunkParallelCoherent2
        extends WindowList {
     ...
     */
    public WindowListReaderSerial2ChunkParallelCoherent2(DataMapper dm) {
        super(dm);
    }
     ...
     */
    public void merge(
        WindowListReaderSerial2ChunkParallelCoherent2 windowList2,
        int dataset
    ) {
