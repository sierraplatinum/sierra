 ...
 */
public class WindowListChunkParallelDatasetWindow
        extends WindowList {
    // temporary list for approach D
     ...
     */
    public WindowListChunkParallelDatasetWindow(DataMapper dm) {
        super(dm);
        windowList = new Hashtable<>();
    }

    /**
     * functions for approach D:
    ...
    public void flattenList() {
        ...
        int last = 0;
        String chr;
        Map<Integer, Window> windowListParallelChr;

        // fill window list
        chromosomeMap = new HashMap<>();
        for (Map.Entry<String, Map<Integer, Window>> windowListParallelChrEntry : windowList.entrySet()) {
