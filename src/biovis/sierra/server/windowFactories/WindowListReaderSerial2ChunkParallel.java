 ...
 */
public class WindowListReaderSerial2ChunkParallel
        extends WindowList {

    // temporary list for approach F-2
     ...
     */
    public WindowListReaderSerial2ChunkParallel(DataMapper dm) {
        super(dm);
    }
     ...
     */
    public void merge(
            WindowListReaderSerial2ChunkParallel windowList2,
            int dataset
    ) {
    ...
    public void flattenList() {
        ...
        for (Map.Entry<String, Vector<ArrayList<Window>>> windowListParallelChrEntry : windowList.entrySet()) {
            ...
            for (List<Window> windowListParallelChunk : windowListParallelChr) {
