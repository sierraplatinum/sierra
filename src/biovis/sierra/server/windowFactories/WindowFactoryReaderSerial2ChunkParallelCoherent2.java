 ...
 */
public class WindowFactoryReaderSerial2ChunkParallelCoherent2
    ...
    public static WindowList constructWindows(
        ...
        log.info("Constructing windows and state; E-2");
        ...
        final WindowListReaderSerial2ChunkParallelCoherent2[] list = new WindowListReaderSerial2ChunkParallelCoherent2[numberOfDataSets];
        ...
        for (int currentDataSetLoop = 0; currentDataSetLoop < numberOfDataSets; currentDataSetLoop++) {
            ...
            list[currentDataSet] = new WindowListReaderSerial2ChunkParallelCoherent2(mapper);
